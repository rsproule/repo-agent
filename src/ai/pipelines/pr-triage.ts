      ...
      try {
        ...
        await prisma.pRAnalysisRecord.upsert({
          ...
          create: {
            ...
            impact: analysis.impact as unknown,
            filesChanged: analysis.filesChanged as unknown,
            recommendations: analysis.recommendations,
            aiGenerated: analysis.aiGenerated as unknown,
          },
          update: {
            summary: analysis.summary,
            relevance: analysis.relevance,
    ...
    const analyzedPRs: PRWithAnalysis[] = dbPRs.map((dbPR) => ({
      ...
      analysis: dbPR.analysis
        ? {
            ...
            impact: dbPR.analysis.impact as unknown,
            filesChanged: dbPR.analysis.filesChanged as unknown,
            recommendations: dbPR.analysis.recommendations as string[],
            aiGenerated: dbPR.analysis.aiGenerated as unknown,
          }
        : undefined,
    }));
